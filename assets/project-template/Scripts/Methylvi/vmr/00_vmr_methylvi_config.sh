#!/usr/bin/env bash
# VMR-to-MethylVI compatibility variables; inject paths from config.
...
export VMR_RESULTS_ROOT="${VMR_RESULTS_ROOT:-${VMR_PROJECT_DIR}/Results/MethylVI/vmr/var_${VMR_METHSCAN_VARIANCE}}"
...
export SCMO_THREADS="$VMR_THREADS" SCMO_SEED="$VMR_SEED" SCMO_EPOCHS="$VMR_EPOCHS"
export SCMO_BATCH_SIZE="$VMR_BATCH_SIZE" SCMO_BATCH_KEY="$VMR_BATCH_KEY" SCMO_CELLTYPE_KEY="$VMR_CELLTYPE_KEY"
