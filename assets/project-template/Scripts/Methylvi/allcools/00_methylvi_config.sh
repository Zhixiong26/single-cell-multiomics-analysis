#!/usr/bin/env bash
# ALLCools-to-MethylVI compatibility variables; inject paths from config.
...
export SCMO_MVI_ROOT="${SCMO_MVI_ROOT:-${SCMO_PROJECT_DIR}/Results/MethylVI/allcools}"
...
export SCMO_EXPECTED_CELLS="${SCMO_EXPECTED_CELLS:-0}"
